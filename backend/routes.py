...
def parse_json(song):
    return json.loads(json_util.dumps(song))
...
def update_song(id):
    ...
    if song_exist:
        update = db.songs.update_one({"id": id}, {"$set":new_data})        
